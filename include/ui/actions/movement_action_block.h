...
{
    Q_OBJECT
    Q_PROPERTY(double linearVelocity READ linearVelocity WRITE setLinearVelocity NOTIFY
                   linearVelocityChanged)
    Q_PROPERTY(double angularVelocity READ angularVelocity WRITE setAngularVelocity NOTIFY
