...
public:
    ...
    void setDisplayProperty(const QString& display_name, const QString& property_name,
...
Q_SIGNALS:
    ...
    void displayPropertyChanged(const QString& display_name, const QString& property_name,
                                const QVariant& value);
