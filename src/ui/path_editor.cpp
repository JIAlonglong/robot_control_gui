...
{
    connect(x_spin_, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &PathEditor::onSpinValueChanged);
    connect(y_spin_, QOverload<int>::of(&QSpinBox::valueChanged),
            this, &PathEditor::onSpinValueChanged);
}
...
void PathEditor::updateWaypoint(int row, int column)
{
    ...
    if (row >= 0 && row < waypoints.size()) {
        ...
        switch (column) {
            ...
            case 2: waypoint["theta"] = value; break;
        }
