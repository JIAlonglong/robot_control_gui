...
ConnectionLine::ConnectionLine(ActionBlockWidget* from, 
...
void ConnectionLine::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
    ...
    QPointF arrowP1 = endPos + QPointF(direction.x() - direction.y(), direction.y() + direction.x()) * 12;
    QPointF arrowP2 = endPos + QPointF(direction.x() + direction.y(), direction.y() - direction.x()) * 12;
